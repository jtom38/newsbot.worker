from newsbotWorker.infrastructure.domain import CacheInterface
from newsbotWorker.infrastructure.models.db import Settings
from newsbotWorker.service.db import SettingsTable
