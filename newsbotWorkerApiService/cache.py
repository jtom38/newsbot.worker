from newsbotWorkerApiInfra.domain import CacheInterface
from newsbotWorkerApiInfra.models import Settings
from newsbotWorkerApiService.db import SettingsTable
