from newsbot.worker.sources.common.exceptions import MissingSourceID
from newsbot.core.sql import SourcesTable, ArticlesTable, SourceLinksTable, DiscordWebHooksTable
from newsbot.core.sql.schema import Sources, DiscordWebHooks, SourceLinks
...
class BaseSources(SourceValidator):
    """
    ...
    def setActiveSource(self, source: SourceName, name: str = "", sourceType: str = '') -> None:
        """
